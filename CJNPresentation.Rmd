---
title: "A Bayesian Hierarchical Model for Plant Macrofossil Time Series"
author: "Connor Nolan"
date: "August 21, 2014"
...
Data: plant macrofossil counts for a given species and fossil type at each time step - $y_{t}$ - and sample volumes - $v_{t}$. 
...
* more complex distribution for the mean of the $\theta{t}$'s perhaps like the one from the pollen model:
$$ 
